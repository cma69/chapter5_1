...
public class chapter5_1 {
        public static void main(String[] args) {
                ...
                if(sc == 1) {
                        ...
                        System.out.println(" The result is" + h(x));
                } else if (sc == 2) {
                        System.out.println("Enter 2 numbers x,y separted by comma to find f(x,y)=x+y");
                        ...
                        System.out.println(" Enter 3 numbers x,y,z separted by comma to find g(x,y,z)");
